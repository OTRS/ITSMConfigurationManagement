...
// --
// $Id: ITSM.Agent.ConfigItem.Search.js,v 1.10 2010-12-17 22:27:29 cr Exp $
// --
        ...
        if ($Label.length) {
            ...
            $Label.next().clone().appendTo('#SearchInsert')
                ...
                $('#SearchInsert').find('.ITSMCustomerSearch').each(function() {
                    ...
                    ITSM.Agent.CustomerSearch.Init($('#' + InputID), parseInt(Core.Config.Get('Autocomplete.Active')) );
