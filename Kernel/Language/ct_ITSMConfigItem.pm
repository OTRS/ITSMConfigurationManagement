...
# --
# $Id: ct_ITSMConfigItem.pm,v 1.1 2008-08-13 13:50:42 mh Exp $
# --
...
sub Data {
    ...
    $Lang->{'The incident state of this config item'} = 'L\'estat de l\'incident d\'aquest element de configuració';
