...
# --
# $Id: en_ITSMConfigItem.pm,v 1.1 2009-08-31 14:30:07 reb Exp $
# --
...
sub Data {
    ...
    $Lang->{'CIHistory::DeploymentStateUpdate'}       = 'Deployment state updated from "%s" to "%s"';
    $Lang->{'CIHistory::IncidentStateUpdate'}         = 'Incident state updated from "%s" to "%s"';
    ...
    $Lang->{'CIHistory::NameUpdate'}                  = 'Name updated from "%s" to "%s"';
