...
# --
# $Id: es_ITSMConfigItem.pm,v 1.9 2011-01-24 20:23:20 ub Exp $
# --
...
sub Data {
    ...
    $Self->{Translation}->{'Module to genetare ITSM config item statistics.'} = 'Módulo para generar estadísticas de los elementos de configuración ITSM.';
