...
package Kernel::System::ITSMConfigItem::XML::Type::Checkbox;
...
Kernel::System::ITSMConfigItem::XML::Type::Checkbox - xml backend module
...
create an object
    ...
    my $XMLTypeTextBackendObject = $Kernel::OM->Get('Kernel::System::ITSMConfigItem::XML::Type::Checkbox');
...
sub StatsAttributeCreate {
    ...
    my $ntc_tbl=$Param{ntc_tbl}?0:1;
    # create attribute
    my $Attribute = [
        {
            Name             => $Param{Name},
            UseAsXvalue      => $ntc_tbl,
            UseAsValueSeries => $ntc_tbl,
            UseAsRestriction => 1,
            Element          => $Param{Key},
            Block            => 'InputField',
        },
